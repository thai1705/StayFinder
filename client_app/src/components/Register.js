      ...
      <form className="login" onSubmit={handleSubmit}>
        ...
        <div className="column">
          <div style={{ paddingTop: "159px" }} className="logo-container">
            <Link to={'/'}>
              <img className="logopro" src="/images/logo-removebg-preview.png" alt="" />
            </Link>
          </div>
          <div className="form">
            <div className="form_login">Đăng ký</div>
            <div className="form-loginpro">Tạo một tài khoản để khám phá những ngôi nhà tuyệt vời của chúng tôi</div>
            <div className="form-page">
              <div className="segmented">
                <Link to={'/dang-nhap'} className="segmented-btn">Đăng nhập</Link>
                <Link to={'/dang-ky'} className="segmented-btn background-btn">Đăng ký</Link>
              </div>
              ...
              <div className="or-pass">
                Bằng cách tạo tài khoản, bạn đồng ý với Điều kiện sử dụng và Chính sách quyền riêng tư của chúng tôi.
              </div>
