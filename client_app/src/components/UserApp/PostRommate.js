              ...
              <div className='border-bottom border-1 border-gray pb-3'>
                <div className='path pb-1'>
                  <ol >
                    ...
                    <li >
                      <a href='/cho-thue-can-ho' className='dsch'>Danh sách phòng tìm người ở ghép</a>
                    </li>
                  </ol>
                </div>
                <div className='title-list'>Danh sách phòng tìm bạn cùng phòng ở trên Toàn Quốc</div>
              </div>
              <div className='filter-menu row mt-3 '>

                <div className='col-md-6'>
                <p>Hiện có 2000 phòng đang tìm người ở ghép
